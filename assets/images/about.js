...
function changeImageSmooth(imageElement, newSrc, infoBox, newTitle) {
    imageElement.style.transition = "transform 0.2s ease, opacity 0.2s ease";
    imageElement.style.transform = "translateX(-50%)";
    imageElement.style.opacity = "0.3";

    setTimeout(() => {
        imageElement.src = newSrc;
        infoBox.textContent = newTitle;
        imageElement.style.transition = "none";
        imageElement.style.transform = "translateX(20%)";
        setTimeout(() => {
            imageElement.style.transition = "transform 0.1s ease, opacity 0.1s ease";
...
function showEvent(event) {
    ...
    document.querySelector('.about-text').scrollTop = 0;
  ...
  const seasonImages = {
    mua_xuan: [
      { src: 'xuan1.png', title: 'Lễ hội đền Huyền Trân Công Chúa' },
      { src: 'xuan2.png', title: 'Chương trình khai mạc năm du lịch quốc gia' },
      { src: 'xuan3.png', title: 'Ngày hội Tinh hoa Võ Việt lần thứ nhất - Huế 2025' }
    ],
    mua_ha: [
      { src: 'ha1.png', title: 'Tuần lễ Phật Đản và Lễ hội Ẩm thực chay' },
      { src: 'ha2.png', title: 'Chương trình “Huế - Kinh đô ẩm thực”' },
      { src: 'ha3.png', title: 'Tuần lễ áo dài cộng đồng Huế' }
    ],
    mua_thu: [
      { src: 'thu1.png', title: 'Ngày hội Thể thao vì sức khỏe cộng đồng - Hue Sports Festival 2025' },
      { src: 'thu2.png', title: 'Hội đèn lồng quốc tế Huế 2025' },
      { src: 'thu3.png', title: 'Ngày hội Quảng diễn Lân - Sư - Rồng & Hội rước đèn Trung thu' }
    ],
    mua_dong: [
      { src: 'dong1.png', title: 'Tuồng Huế, Ngàn xưa âm vọng' },
      { src: 'dong2.png', title: 'Tuần lễ Âm nhạc quốc tế Huế 2025' },
      { src: 'dong3.png', title: 'Bế mạc Năm Du lịch quốc gia Huế - 2025' },
    ]
  };
    ...
    if (event !== 'gioi_thieu') {
        const slide_about = document.createElement('div');
        slide_about.style.position = 'absolute';
        slide_about.style.top = '105%';
        slide_about.style.left = '0%';
        slide_about.style.width = '100%';
        slide_about.style.height = '60%';
        // slide_about.style.border = '2px solid #ccc';
        seasonImagesContainer.appendChild(slide_about);
        const img = document.createElement('img');
        slide_about.appendChild(img);

        img.src = `./assets/images/nut.png`;
        ...
        // img.style.border = '2px solid #dab67d';
        ...
        infoBox.textContent = 'Thông tin ảnh';
        ...
        img.addEventListener('mouseover', (e) => {
            img.style.background = 'linear-gradient(to bottom, transparent 0%, #dab67d 50%, transparent 100%)';
        ...
        slide_about.appendChild(img);
        slide_about.appendChild(infoBox);
        slide_about.appendChild(image);
        if (event === 'mua_xuan') {
            
            image.src = `./assets/images/${seasonImages.mua_xuan[index_xuan].src}`;
            infoBox.textContent = seasonImages.mua_xuan[index_xuan].title;
            img.addEventListener('click', () => {
                index_xuan++;
                console.log(index_xuan);
                if(index_xuan >= seasonImages.mua_xuan.length) {
                    index_xuan = 0;
                }
                changeImageSmooth(
                    image,
                    `./assets/images/${seasonImages.mua_xuan[index_xuan].src}`,
                    infoBox,
                    seasonImages.mua_xuan[index_xuan].title
                );
            });
            // seasonImagesContainer.appendChild(infoBox);
            // seasonImagesContainer.appendChild(image);
            seasonImagesContainer.appendChild(slide_about);
        }
        else if (event === 'mua_ha') {
            image.src = `./assets/images/${seasonImages.mua_ha[index_ha].src}`;
            infoBox.textContent = seasonImages.mua_ha[index_ha].title;
            img.addEventListener('click', () => {
                index_ha++;
                if(index_ha >= seasonImages.mua_ha.length) {
                    index_ha = 0;
                }
                changeImageSmooth(
                    image,
                    `./assets/images/${seasonImages.mua_ha[index_ha].src}`,
                    infoBox,
                    seasonImages.mua_ha[index_ha].title
                );
            });
            // seasonImagesContainer.appendChild(infoBox);
            // seasonImagesContainer.appendChild(image);
            ...
            image.src = `./assets/images/${seasonImages.mua_thu[index_thu].src}`;
            infoBox.textContent = seasonImages.mua_thu[index_thu].title;
            img.addEventListener('click', () => {
                index_thu++;
                if(index_thu >= seasonImages.mua_thu.length) {
                    index_thu = 0;
                }
                changeImageSmooth(
                    image,
                    `./assets/images/${seasonImages.mua_thu[index_thu].src}`,
                    infoBox,
                    seasonImages.mua_thu[index_thu].title
                );
            });
            // seasonImagesContainer.appendChild(infoBox);
            // seasonImagesContainer.appendChild(image);
            ...
            image.src = `./assets/images/${seasonImages.mua_dong[index_dong].src}`;
            infoBox.textContent = seasonImages.mua_dong[index_dong].title;
            img.addEventListener('click', () => {
                index_dong++;
                if(index_dong >= seasonImages.mua_dong.length) {
                    index_dong = 0;
                }
                changeImageSmooth(
                    image,
                    `./assets/images/${seasonImages.mua_dong[index_dong].src}`,
                    infoBox,
                    seasonImages.mua_dong[index_dong].title
                );
                // image.src = `./assets/images/${seasonImages.mua_dong[index_dong].src}`;
                // infoBox.textContent = seasonImages.mua_dong[index_dong].title;
            });
